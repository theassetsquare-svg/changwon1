...
const PAGES = [
  ...
  { path: "/bulgwang-hobak-1/", priority: "0.9", changefreq: "weekly", thumb: "/og-bulgwang.png" },
  // /night/{slug}/ 지역별 업소 정보 페이지 13개 (append)
  { path: "/night/bulgwang-hobak-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/bulgwang-hobak-1-night-guide-og.png" },
  { path: "/night/changwon-lululala-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/changwon-lululala-1-og.png" },
  { path: "/night/ulsan-champion-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/ulsan-champion-1-og.png" },
  { path: "/night/cheongdam-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/cheongdam-1-og.png" },
  { path: "/night/daejeon-one-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/daejeon-one-night-og.png" },
  { path: "/night/sillim-grandprix-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/sillim-grandprix-1-og.png" },
  { path: "/night/sangbong-hangukgwan-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/sangbong-hangukgwan-1-hall-og.png" },
  { path: "/night/suyu-shampoo-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/suyu-shampoo-1-hall-og.png" },
  { path: "/night/busan-asiad-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/busan-asiad-night-og.png" },
  { path: "/night/suwon-chancedome-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/suwon-chancedome-1-hall-og.png" },
  { path: "/night/ansan-hit-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/ansan-hit-1-og.png" },
  { path: "/night/daejeon-seven-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/daejeon-seven-1-og.png" },
  { path: "/night/ilsan-shampoo-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/ilsan-shampoo-1-hall-og.png" },
