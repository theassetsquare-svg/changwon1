...
const PAGES = [
  ...
  { path: "/contacta-1/", priority: "0.85", changefreq: "monthly", thumb: "/og/page-contacta-og.png" },
  ...
  { path: "/bulgwang-hobak-5/", priority: "0.9", changefreq: "weekly", thumb: "/og-bulgwang.png" },
  // /night/{slug}/ 지역별 업소 정보 페이지 13개 (append)
  { path: "/bulgwang-hobak-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/bulgwang-hobak-night-og.png" },
  { path: "/changwon-lululala-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/changwon-lululala-night-og.png" },
  { path: "/ulsan-champion-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/ulsan-champion-4-og.png" },
  { path: "/cheongdam-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/cheongdam-4-og.png" },
  { path: "/night/daejeon-one-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/daejeon-one-night-og.png" },
  { path: "/sillim-grandprix-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/sillim-grandprix-4-og.png" },
  { path: "/sangbong-hangukgwan-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/sangbong-hangukgwan-4-og.png" },
  { path: "/suyu-shampoo-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/suyu-shampoo-4-og.png" },
  { path: "/busan-asiad-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/busan-asiad-1-og.png" },
  { path: "/suwon-chancedome-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/suwon-chancedome-4-og.png" },
  { path: "/ansan-hit-night-1/", priority: "0.8", changefreq: "weekly", thumb: "/og/ansan-hit-4-og.png" },
  { path: "/daejeon-seven-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/daejeon-seven-4-og.png" },
  { path: "/ilsan-shampoo-night-2/", priority: "0.8", changefreq: "weekly", thumb: "/og/ilsan-shampoo-4-og.png" },
  // /access/ 허브 — 전국 나이트 가는 길 40
  { path: "/access-3/", priority: "0.9", changefreq: "weekly", thumb: "/og/page-access-og.png" },
];
