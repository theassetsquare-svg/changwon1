...
const PAGES = [
  ...
  { path: "/bulgwang-hobak-guide/", priority: "0.9", changefreq: "weekly", thumb: "/og-bulgwang.png" },
  ...
  { path: "/night/suyu-shampoo-night-hall/", priority: "0.8", changefreq: "weekly", thumb: "/og/suyu-shampoo-night-guide-hall-og.png" },
  { path: "/night/busan-asiad-night/", priority: "0.8", changefreq: "weekly", thumb: "/og/busan-asiad-night-og.png" },
  { path: "/night/suwon-chance-dome-night-hall/", priority: "0.8", changefreq: "weekly", thumb: "/og/suwon-chance-dome-night-guide-hall-og.png" },
  ...
  { path: "/night/ilsan-shampoo-night-hall/", priority: "0.8", changefreq: "weekly", thumb: "/og/ilsan-shampoo-night-guide-hall-og.png" },
