  ...
  return (
    <>
      <SeoHead
        ...
        description="내비만 믿고 골목에서 돌지 마세요. 의창·성산·마산·진해 어디서 오시든 가장 빠른 길, 신분증·인원·입구 멘트까지 담당이 도착 직전 안내해 드립니다."
      ...
      <section className="section--tight">
        <div className="container">
          <div className="card">
            ...
            <dl className="kv">
              <dt>상세 위치</dt>
              <dd>직접 안내 (오시기 직전 한 번이면 가장 정확합니다)</dd>
            </dl>
            <dl className="kv">
              <dt>영업시간</dt>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="lead" style={{ marginTop: 14 }}>
            ...
            돌아가는 분들이 꽤 있습니다. 도착 직전에 담당한테 한 번이면,
      ...
      <section className="section--tight">
        <div className="container">
          <div className="notice">
            ...
            담당한테 직접 안내 받으시는 게 가장 빠르고 정확합니다.
          </div>
        </div>
      </section>
    </>
