  ...
  return (
    <>
      <SeoHead
        ...
        description="내비만 믿고 골목에서 돌지 마세요. 의창·성산·마산·진해 어디서 오시든 가장 빠른 길, 신분증·인원·입구 멘트까지 담당이 도착 직전 카톡으로 잡아드립니다."
      ...
      <section className="section--tight">
        <div className="container">
          <div className="card">
            ...
            <dl className="kv">
              <dt>상세 위치</dt>
              <dd>카톡으로 직접 안내 (오시기 직전 한 번이면 가장 정확합니다)</dd>
            </dl>
            <dl className="kv">
              <dt>카톡 문의</dt>
              <dd>
      ...
      <section className="section">
        <div className="container">
          <span className="eyebrow">왜 카톡으로 안내하나</span>
          <h2>지도보다 사람이 빠릅니다.</h2>
          <p className="lead" style={{ marginTop: 14 }}>
            처음 가는 골목, 야간 조명, 모르는 일방통행. 지도만 믿고 들어오면
            돌아가는 분들이 꽤 있습니다. 도착 직전에 담당한테 카톡 한 번이면,
      ...
      >
        <div className="container">
          ...
          <p className="lead" style={{ marginTop: 14 }}>
            ...
            편한지 대략 적어 둘게요. 정확한 진입 경로는 도착 직전에 담당이
            잡아드립니다.
          </p>
          <div className="grid grid-3" style={{ marginTop: 28 }}>
            ...
            <article className="card">
              ...
              <p style={{ marginTop: 10 }}>
                ...
                한 번, 가게 근처에서 한 번이면 좁은 골목 헤맬 일 없어요.
              </p>
            </article>
            <article className="card">
              <h3>외지에서 오시는 분</h3>
              <p style={{ marginTop: 10 }}>
                ...
                기사님이 빠르게 알아듣는지, 그 멘트도 카톡으로 알려드립니다.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="lead" style={{ marginTop: 14 }}>
            ...
            마무리가 꽤 달라집니다. 손님들 응대하면서 본 일반적인 패턴
            정리해 드릴게요.
          </p>
          <div className="grid grid-2" style={{ marginTop: 26 }}>
            ...
            <article className="card">
              ...
              <p style={{ marginTop: 10 }}>
                ...
                기사님께 어떻게 말씀하시면 좋을지 도착 전 카톡으로 알려드릴게요.
              </p>
            </article>
            <article className="card">
              <h3>도보 (인근 거주·숙박)</h3>
              <p style={{ marginTop: 10 }}>
                ...
                오실 수 있는 거리예요. 정확한 동선은 그날 담당이 챙겨드립니다.
              </p>
            </article>
            <article className="card">
              <h3>일행 픽업</h3>
              <p style={{ marginTop: 10 }}>
                ...
                포인트를 미리 잡아 두시면 좋아요. 그 포인트도 카톡으로 정해드립니다.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <ol className="steps" style={{ marginTop: 24 }}>
            <li>
              <strong>입구 직원한테 "담당"</strong>
              이 한 줄이면 바로 안쪽으로 연결됩니다. 다른 멘트는 필요 없어요.
              담당이 안에 있으면 그쪽에서 받고, 응대 중이면 다른 직원이 자리로
              먼저 안내합니다.
            </li>
            <li>
