...
export default function Contact() {
  return (
    <>
      <SeoHead
        title="예약·문의 · 창원 룰루랄라 나이트 (단체석 포함)"
        description="창원 룰루랄라 나이트 예약·문의 안내. 인원과 도착 시간만 알려주시면 담당이 자리부터 입장까지 정리해 드립니다. 6명 이상 단체석 가이드 포함."
      ...
      <section className="section" style={{ background: "var(--bg-elev)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div className="container">
          ...
          <p className="lead" style={{ marginTop: 14 }}>
            ...
            미리 담당한테 잡아 두시면 그날 저녁이 훨씬 매끄럽게 흘러갑니다.
          </p>
          <ul className="bullets" style={{ marginTop: 22 }}>
            <li>
