...
const FAQ = [
  ...
  {
    q: "예약은 필수인가요?",
    a: "필수는 아니지만, 주말이나 늦은 시간엔 미리 문의 주시는 게 안전합니다. 자리 상황·인원수에 맞춰 담당이 조율해 드립니다.",
  },
  {
    q: "신분증을 꼭 챙겨야 하나요?",
  ...
  {
    q: "혼자 가도 되나요?",
    a: "가능합니다. 다만 자리 배치상 일행과 함께 오시는 게 일반적이라, 혼자 오실 거면 도착 전에 문의 주시면 그날 상황에 맞게 담당이 잡아드립니다.",
  },
  {
    q: "단체로 가도 받아주나요?",
    a: "받습니다. 인원이 6명 이상이면 자리 배치에 시간이 걸리니, 가능하면 두세 시간 전에는 미리 알려주세요. 단체석 흐름은 담당이 따로 정리해 둡니다.",
  },
  {
    q: "영업 시간이 어떻게 되나요?",
...
export default function Home() {
  return (
    <>
      <SeoHead
        title="창원 룰루랄라 나이트 · 자리 잡는 가장 빠른 방법 · 창원 시내 합법 영업장"
        description="창원에서 노는 밤, 입구에서 두리번거리지 마세요. 룰루랄라 나이트 담당 웨이터한테 한 번이면 자리·인원·도착 시간까지 정리됩니다. 19세 이상 합법 영업장 · 신분증 확인."
        keywords="창원 룰루랄라 나이트, 창원룰루랄라나이트, 창원 나이트, 창원나이트, 창원 나이트 예약, 창원 시내 나이트"
        path="/"
      />
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1 style={{ marginTop: 18 }}>
            ...
            <span className="accent">담당</span> 한 번이면 끝.
          </h1>
          <p className="hero__sub">
            처음이든 단골이든, 도착 전에 한 번 연락하면 자리·시간·인원까지
      ...
      <section className="section">
        <div className="container">
          <span className="eyebrow">왜 담당한테 문의하나</span>
      ...
      >
        <div className="container">
          ...
          <ol className="steps" style={{ marginTop: 28 }}>
            ...
            <li>
              <strong>자리 확보</strong>
              상황 보고 자리를 잡아 둡니다. 변경되면 다시 한 번 알려주시면 충분합니다.
            </li>
            <li>
        ...
        <div className="container">
          ...
          <div className="grid grid-2" style={{ marginTop: 26 }}>
            ...
            <article className="card">
              <h3>그다음에 정리할 세 가지</h3>
              <p style={{ marginTop: 10 }}>
                이름, 일행 수, 도착 예정 시간. 셋만 알려주시면 됩니다. 예를 들면
          ...
          <div className="grid grid-3" style={{ marginTop: 28 }}>
            ...
            <article className="card">
              ...
              <p style={{ marginTop: 10 }}>
                ...
                가능성이 있어요. 이 시간대에 오실 거면 최소 두 시간 전엔 미리 연락 주세요.
              </p>
            </article>
            <article className="card">
      ...
      <section className="section">
        <div className="container">
          ...
          <ul className="bullets" style={{ marginTop: 22 }}>
            <li>
              <strong>두 번째부터는 이름만</strong> — 한 번 자리 잡았던 분은 다음 연락
            ...
            <li>
              <strong>연락 한 번이면 흐름이 끊기지 않습니다</strong> — 처음 연락하든 열 번째 연락하든,
